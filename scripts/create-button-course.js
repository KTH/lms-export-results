...
async function start() {
  console.log(
    'This is the "create-button-course" script.\n\n' +
      "Here you will create or edit a button for the Export results app\n" +
  ...
  const { buttonUrl } = await inquirer.prompt({
    ...
    choices: [
      ...
      //   value: "https://localdev.kth.se:4443/api/transfer-to-ladok/",
      // },
      {
        name: "stage (referens)",
        value:
          "https://api-r.referens.sys.kth.se/api/lms-export-results/export",
      },
      {
        name: "production (app.kth.se)",
        value: "https://api.kth.se/api/lms-export-results/export",
      },
    ],
  });

  let defaultName = "KTH Export results 2.0 (beta)";

  /* if (buttonUrl === "https://localdev.kth.se:4443/transfer-to-ladok/") {
    defaultName = "Export results - localdev.kth.se";
  } else */ if (
    buttonUrl ===
    "https://api-r.referens.sys.kth.se/api/lms-export-results/export"
  ) {
    defaultName = "Export results - referens";
  }
